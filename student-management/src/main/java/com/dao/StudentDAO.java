...
public class StudentDAO {
	...
	public boolean addStudent(Student student) {
		...
		try {
			...
			String sql="INSERT INTO students(name,dob,address,qualification,email) VALUES (?,?,?,?,?)";
	...
	public boolean updateStudent(Student student) {
		...
		try {
			...
			String sql="UPDATE students SET name=?,dob=?,address=?,qualification=?,email=? WHERE id=?";
